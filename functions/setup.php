...
if ( ! function_exists('b4st_setup') ) {
    ...
    update_option('small_size_w', 360); /* internal max-width of col-4 */
    update_option('small_size_h', 360); /* internal max-width of col-4 */
    update_option('medium_size_w', 730); /* internal max-width of col-8 */
    update_option('medium_size_h', 730); /* internal max-width of col-8 */
    update_option('large_size_w', 1280); /* internal max-width of col-12 */
    update_option('large_size_h', 1080); /* internal max-width of col-12 */

    add_image_size('square', $width=960, $height=960, true);  //array( 'center', 'center' ) );
...
if ( ! function_exists('b4st_excerpt_more') ) {
    function b4st_excerpt_more() {
        return '</p><p><a class="btn btn-primary" href="'. get_permalink() . '">' . ' <i class="fas fa-angle-right"></i>'. __('See Full Story', 'b4st') . '</a></p>';
    }
}
