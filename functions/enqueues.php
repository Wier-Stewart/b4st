...
if ( ! function_exists('b4st_enqueues') ) {
	function b4st_enqueues() {
        ...
        // Styles
        wp_register_style('bootstrap-css', 'https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-beta.3/css/bootstrap.min.css', false, '4.0.0-beta.3', null);
        ...
        // Scripts: Most of these can/should be in ./src/scripts/vendor
